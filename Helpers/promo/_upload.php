<?php
	...
	$uploads_dir = 'Helper/promo/elements/img/uploads';//specify the upload folder, make sure it's writable!
	$relative_path = 'Media/images/promo/'.$user_id.'/img';//specify the relative path from your elements to the upload folder
