            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <form action="/typeadverts/edit/<?=$id?>" method="post" id="demo-form2">
                            <div class="col-xs-2">
                                <!-- Nav tabs -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="deactivate" id="deactivate" <?=($GetActiveTypeAdverts['active'] == '0')?'checked':''?> value="1" />
                            </div>
                            <div class="form-group">
