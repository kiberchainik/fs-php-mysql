            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <a href="/hobbi/new" class="btn btn-success pull-right">Новый интерес</a>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                <?php if(!empty($hobbiList)): ?>
                                <?php foreach($hobbiList as $v): ?>
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?=$v['name']?></td>
                                    <td class=" ">
                                        <a href="/hobbi/edit/<?=$v['id_hobbi']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/hobbi/trash/<?=$v['id_hobbi']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
