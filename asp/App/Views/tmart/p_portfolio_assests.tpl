            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <a href="/assests/new" class="btn btn-success pull-right">Новый интерес</a>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                <?php if(!empty($assestsList)): ?>
                                <?php foreach($assestsList as $v): ?>
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?=$v['name']?></td>
                                    <td class=" ">
                                        <a href="/assests/edit/<?=$v['id_assests']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/assests/trash/<?=$v['id_assests']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
