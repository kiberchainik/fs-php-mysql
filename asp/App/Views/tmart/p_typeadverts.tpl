                ...
                <div class="row">
                    <div class="private_wrapp">
                        <div class="col-sm-12">
                            ...
                            <a href="/typeadverts/new" class="btn btn-success pull-right">Добавить тип</a>
                        </div>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                <tr class="categoryT even pointer">
                                    ...
                                    <td class=" ">
                                        <a href="/typeadverts/edit/<?=$v['id_type']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/typeadverts/delete/<?=$v['id_type']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
