            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <form action="/interests/new" method="post">
                            <div class="col-xs-2">
                                <!-- Nav tabs -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane <?=($k == '0')?'active':''?>" id="lang<?=$v['id']?>">
                                        <div class="form-group">
                                            ...
                                            <input id="interest<?=$v['id']?>" placeholder="<?=$v['title']?>"  name="interest[<?=$v['id']?>][name]" class="form-control col-md-7 col-xs-12" type="text" />
                                        </div>
                                    </div>
                                    <?php endforeach ?>
                                </div>
