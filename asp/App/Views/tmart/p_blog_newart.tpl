            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <form method="post" action="/blognewarticle" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <table class="table">
                                    <tr>
                                        <td>Логотип<input type="file" name="artLogo" /></td>
                                        <td>On <input type="radio" name="showart" value="1" /> / 
                                        Off <input type="radio" name="showart" value="0" /></td>
                                        <td><button type="submit" name="addnewarticle" class="btn btn-success">Добавить</button></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-xs-2">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane <?=($k == '0')?'active':''?>" id="lang<?=$v['id']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="fullarticletext_<?=$v['id']?>" name="category_description[<?=$v['id']?>][fullarticletext]"></textarea>
                                        </div>
                                    </div>
                                    <?php endforeach ?>
                                </div>
