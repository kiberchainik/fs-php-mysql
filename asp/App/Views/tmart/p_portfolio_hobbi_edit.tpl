            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <form action="/hobbi/edit/<?=$hobbiData['hobbi'][1]['id_hobbi']?>" method="post">
                            <div class="col-xs-2">
                                <!-- Nav tabs -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane <?=($k == '0')?'active':''?>" id="lang<?=$v['id']?>">
                                        <div class="form-group">
                                            ...
                                            <input id="hobbi<?=$v['id']?>" name="hobbi[<?=$v['id']?>][name]" value="<?=$hobbiData['hobbi'][$v['id']]['name']?>" class="form-control col-md-7 col-xs-12" type="text" />
                                        </div>
                                    </div>
                                    <?php endforeach ?>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        <input type="text" id="active" value="<?=$hobbiData['active'][0]['val']?>" name="active" class="form-control col-md-7 col-xs-12" />
                                    </div>
                                </div>
                                <div class="form-group">
