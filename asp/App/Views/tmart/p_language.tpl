            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <a href="/language/new" class="btn btn-success pull-right">Добавить</a>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?=$v['title']?></td>
                                    <td class=" "><?=($v['status'] == '1')?'Установлен':'Не установлен'?></td>
                                    <td class=" ">
                                        <a href="/language/edit/<?=$v['id']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/language/trash/<?=$v['id']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
