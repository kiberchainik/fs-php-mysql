            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <a href="/country/new" class="btn btn-success pull-right">Добавить</a>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?=$v['name']?></td>
                                    <td class=" ">
                                        <a href="/country/edit/<?=$v['id']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/country/trash/<?=$v['id']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
