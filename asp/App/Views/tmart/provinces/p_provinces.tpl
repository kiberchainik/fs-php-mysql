            ...
            <div class="col-md-9 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="private_wrapp">
                        <a href="/provinces/new" class="btn btn-success pull-right">Добавить</a>
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title" style="display: table-cell;">Провинция </th>
                            ...
                            <tbody>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?=$v['p_name']?></td>
                                    <td class=" ">
                                        <a href="/provinces/edit/<?=$v['id']?>" class="btn btn-sm btn-success">Изменить</a>
                                        <a href="/provinces/trash/<?=$v['id']?>" class="btn btn-sm btn-danger">Удалить</a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php else: ?>
