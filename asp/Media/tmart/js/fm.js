...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		load = function() {
			require(
				[
					'elfinder'
					, '/Helpers/fm/js/extras/editors.default.min'               // load text, image editors
					, 'elFinderConfig'
	...
	require.config({
		...
		paths : {
			...
			'elfinder' : '/Helpers/fm/js/elfinder.min',
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				url : '/home5/urlpyrtf/public_html/asp/Helpers/fm/php/connector.minimal.php' // connector URL (REQUIRED)
				,commandsOptions : {
					edit : {
						extraOptions : {
