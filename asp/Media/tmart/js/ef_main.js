(function(){
	...
	var // jQuery and jQueryUI version
		...
		load = function() {
			require(
				[
					'elfinder'
					, 'https://findsol.it/asp/Helpers/elfinder/js/extras/editors.default.min'               // load text, image editors
					, 'elFinderConfig'
	...
	require.config({
		...
		paths : {
			...
			'elfinder' : 'https://findsol.it/asp/Helpers/elfinder/js/elfinder.min',
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				url : 'https://asp.findsol.it/Helpers/elfinder/php/connector.minimal.php' // connector URL (REQUIRED)
				,commandsOptions : {
					edit : {
						extraOptions : {
