...
<body>
    <div id="conteiner">
        <div id="leftbar">
            ...
            <div id="user_data">
                <div class="data_element"><img src="https://img.icons8.com/external-tanah-basah-basic-outline-tanah-basah/16/000000/external-user-user-tanah-basah-basic-outline-tanah-basah-6.png" class="icon" /><p style="text-transform: uppercase;">{user_name}</p></div>
        ...
        <div id="content">
            <div id="cnt-body">
                <div style="font-size: 13px; width: 480px; margin-top: 30px"><div>{about_user}</div></div>
