<link href="Helpers/promo/css/custom.css" rel="stylesheet"/>
<body>
    <div id="builder">
        <div class="menu" id="menu">
            <div class="main scrollbar-inner" id="main">
                ...
                <div class="sideButtons clearfix">
                    <a href="#" class="btn fs-button btn-sm" id="addPage">
        ...
        <div class="container">
            <header class="clearfix fs-custom-header" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
                <ul class="fs-btns pull-right">
                    <li><span class="fui-check fs-icon"></span><a href="#" id="savePage" data-toggle="modal" class="fs-btn"><span class="bLabel">Nothing to save</span></a></li>
                    <li><span class="fui-gear fs-icon"></span><a href="#seoModal" id="seoButton" data-toggle="modal" class="fs-btn actionButtons"><span>SEO</span></a></li>
                    <li><span class="fui-export fs-icon"></span><a href="#exportModal" id="exportPage" data-toggle="modal" class="fs-btn actionButtons"><span>Settings</span></a></li>                                        
                    <li><span class="fui-window fs-icon"></span><a href="#previewModal" data-toggle="modal" class="fs-btn actionButtons" id="buttonPreview"><span>Save promo page</span></a></li>
                    <li><span class="fui-trash fs-icon"></span><a href="#" id="clearScreen" class="fs-btn actionButtons"><span>Empty Page</span></a></li>
                </ul>

                <div class="modes fs-radio-btn" id="siteBuilderModes">
                    <b>BUILDING MODE:</b>
        ...
        <div id="styleEditor" class="styleEditor scrollbar-inner">
                        ...
                        <div class="form-group">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="btn btn-primary btn-sm  fileinput-exists" data-dismiss="fileinput"><span class="fui-trash"></span>&nbsp;&nbsp;Remove</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="margin-bottom-5">
                <button type="button" class="btn fs-button  btn-sm btn-block no-margin-left" id="saveStyling"><span class="fui-check-inverted"></span> Apply Changes</button>
            </div>
            <div class="sideButtons clearfix">
                <button type="button" class="btn fs-button dark  btn-xs no-margin-left" id="cloneElementButton">
                    <span class="fui-windows"></span> Clone
                </button>
                <button type="button" class="btn fs-button orange btn-xs" id="resetStyleButton">
                    <i class="fa fa-refresh"></i> Reset
                </button>
                <button type="button" class="btn fs-button danger btn-xs" data-target="#deleteElement" data-toggle="modal" id="removeElementButton">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header palette-turquoise">
                    ...
                    <h4 class="modal-title" id="myModalLabel">SEO Settings for <span id="fox_b_seo_title" class="text-primary pName">index.html</span></h4>
                </div>
                    ...
                    <form class="form-horizontal" role="form" id="pageSettingsForm" action="">
                        ...
                        <div class="optionPane">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="fox_b_seo_page_Title" name="fox_b_seo_page_Title" placeholder="Page title" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-8 control-label">Page Meta Description</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control" id="fox_b_seo_metaDescription" name="fox_b_seo_metaDescription" placeholder="Page meta description"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-8 control-label">Page Meta Keywords</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control" id="fox_b_seo_metaKeywords" name="fox_b_seo_metaKeywords" placeholder="Page meta keywords"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-8 control-label">Page Author</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control" id="fox_b_seo_header" name="fox_b_seo_header" rows="5" placeholder="Add Author Name here.."></textarea>
                                </div>
                            </div>
                        </div><!-- /.optionPane -->
                    </form>                           
                ...
                <div class="modal-footer">
                    <button type="button" class="btn fs-button danger  btn-cancel" data-dismiss="modal"><span class="fui-cross"></span> Cancel</button>
                    <button type="button" class="btn fs-button" data-dismiss="modal" id="seoSubmittButton"><span class="fui-gear"></span> Save SEO Settings</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div>
        ...
        <form action="_export.php" target="_blank" id="markupForm" method="post" class="form-horizontal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="pageSettingsForm" class="form-horizontal" role="form" action="">

                        <div class="panel-group" id="accordion">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#emailcampaign">
                                        Email Campaign Settings
                                        </a>
                                    </h4>
                                </div>
                                <div id="emailcampaign" class="panel-collapse collapse in">
                                    <div class="panel-body save-wrap">
                                        <div class="optionPane">
                                            <div class="full-group">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <select name="export_type" class="form-type" id="export_type">
                                                        <option value="fox_b_active">ActiveCampaign</option>
                                                        <option value="fox_b_aweber">AWeber</option>
                                                        <option value="fox_b_campain">CampaginMonitor</option>
                                                        <option value="fox_b_response">GetResponse</option>
                                                        <option value="fox_b_mailchimp">Mailchimp</option>
                                                        <option value="fox_b_mailerlite">MailerLite</option>
                                                    </select>
                                                </div>
                                                <div class="export-content">
                                                    <div class="export_change_type" id="fox_b_mailchimp" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            ...
                                                            <div class="fox-b-notice">Your API key from here - <a href="http://admin.mailchimp.com/account/api" target="_blank">http://admin.mailchimp.com/account/api</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="fox-b-notice">List unique id from here - <a href="http://admin.mailchimp.com/lists/" target="_blank">http://admin.mailchimp.com/lists/</a></div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type" id="fox_b_campain" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            <label for="name" class="col-sm-8 control-label">Your API Key</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="cm_api_key" id="cm_api_key" placeholder="Campaign Monitor API KEY" value="" />
                                                            </div>
                                                            <div class="fox-b-notice">APIKEY from here - <a href="https://YOUR-USERNAME.createsend.com/admin/account/" target="_blank">YOUR-USERNAME.createsend.com/admin/account/</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="fox-b-notice">List ID from here - <a href="https://www.campaignmonitor.com/api/getting-started/#listid<" target="_blank">www.campaignmonitor.com/api/getting-started/#listid</a></div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type" id="fox_b_response" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            <label for="name" class="col-sm-8 control-label">Your API Key</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="getresponse_api_key" id="getresponse_api_key" placeholder="GetResponse API key" value="" />
                                                            </div>
                                                            <div class="fox-b-notice">Your API key from here - <a href="https://app.getresponse.com/my_api_key.html" target="_blank">app.getresponse.com/my_api_key.html</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="fox-b-notice">Campaign name from here - <a href="https://app.getresponse.com/campaign_list.html" target="_blank">app.getresponse.com/campaign_list.html</a></div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type" id="fox_b_aweber" style="display: none;">
                                                        <div class="form-group  fox-b-position">
                                                            <div class="col-sm-12">
                                                            <strong>Notes:</strong> 
                                                            <p>First you need to allow access of your Aweber account to Foxstar Aweber App. <a target="_blank" class="btn  btn-primary btn-click-here" href="../builder/elements/fox_b_mail/getaccess.php">click here</a> to allow access.


</p>
                                                            <p>If you want to use your own Aweber App then you need to add your Aweber App’s Consumer Key and Secret Key in these files (builder/elements/fox-mail/getaccess.php).</p>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="fox-b-notice">List name from here - <a href="https://www.aweber.com/users/autoresponder/manage" target="_blank">https://www.aweber.com/users/autoresponder/manage</a></div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type active" id="fox_b_active" style="display:block;">
                                                        <div class="form-group fox-b-position">
                                                            ...
                                                            <div class="fox-b-notice">To get your Api Url : Go to My Settings -> Developers</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Your API Key</label>
                                                            <div class="col-sm-12">
                                                            ...
                                                            <div class="fox-b-notice">To get your Api Key :- Go to My Settings -> Developers</div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="export_change_type" id="fox_b_mailerlite" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            <label for="name" class="col-sm-8 control-label">Your API Key</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="ml_api_key" id="ml_api_key" placeholder="MailerLite API Key" value="">
                                                            </div>
                                                            <div class="fox-b-notice">To get your API Key : Go to <a href="https://app.mailerlite.com/integrations/api/" target="_blank">https://app.mailerlite.com/integrations/api/</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="fox-b-notice">To get your List ID (GroupID) : Go to <a href="https://app.mailerlite.com/integrations/api/" target="_blank">https://app.mailerlite.com/integrations/api/</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#contactForm">
                                        Contact Form Settings
                                        </a>
                                    </h4>
                                </div>
                                <div id="contactForm" class="panel-collapse collapse">
                                    <div class="panel-body import-wrap">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Recipient Email Address</label>
                                            <div class="col-sm-12">
                                                <input type="email" class="form-control" name="contact_email" id="contact_email" placeholder="Enter contact email..." value="contact@yourdomain.com" />
                                            </div>
                                            <div class="fox-b-notice">Enter your email address where you want to receive contact form information!</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#socialsettings">
                                        Social Settings
                                        </a>
                                    </h4>
                                </div>
                                <div id="socialsettings" class="panel-collapse collapse">
                                    <div class="panel-body save-wrap">
                                        <div class="optionPane">
                                            <div class="full-group">
                                                <div class="form-group col-sm-12">
                                                    <label for="name" class="control-label">Select Social Network:</label>
                                                    <select name="social_network" class="form-type" id="social_network">
                                                        <option value="fox_b_twitter">Twitter</option>
                                                        <option value="fox_b_instagram">Instagram</option>
                                                        <option value="fox_b_flickr">Flickr</option>
                                                    </select>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="social-content">
                                                    <div class="export_change_type active" id="fox_b_twitter" style="display:block;">
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Twitter Screen Name</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="twitter_screen_name" id="twitter_screen_name" placeholder="Enter your screen name here.." value="wowthemez">
                                                            </div>
                                                            <div class="fox-b-notice">Enter your twitter screenname or username!</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Max Tweets Shows</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="twitter_max_tweets" id="twitter_max_tweets" placeholder="Max tweets shows" value="3">
                                                            </div>
                                                            <div class="fox-b-notice">You can control how many tweets show. Default is 3.</div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type" id="fox_b_instagram" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            <label for="name" class="col-sm-8 control-label">Client ID</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="insta_client_id" id="insta_client_id" placeholder="Enter your client ID here..." value="b84a5448343245f88dd43e62ba0cc9a8" />
                                                            </div>
                                                            <div class="fox-b-notice">Register Client ID from here - <a href="http://instagram.com/developer/clients/register/" target="_blank">http://instagram.com/developer/clients/register/</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Access Token</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="insta_access_token" id="insta_access_token" placeholder="Enter your access token here..." value="4793566378.b84a544.7bc3d435c78d43beb7766d0387395ddd" />
                                                            </div>
                                                            <div class="fox-b-notice">For instagram access token <a href="https://elfsight.com/blog/2015/10/get-instagram-client-id-guide/" target="_blank">follow this tutorial</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">User ID</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="insta_user_id" id="insta_user_id" placeholder="Enter your user id here..." value="4793566378" />
                                                            </div>
                                                            <div class="fox-b-notice">Find your user ID  <a href="https://www.otzberg.net/iguserid/" target="_blank">from here</a></div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Image Shows</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="insta_img_limit" id="insta_img_limit" placeholder="Choose how many image want to show" value="6" />
                                                            </div>
                                                            <div class="fox-b-notice">Choose how many image you want to show. Default is 6.</div>
                                                        </div>
                                                    </div>
                                                    <div class="export_change_type" id="fox_b_flickr" style="display:none;">
                                                        <div class="form-group fox-b-position">
                                                            <label for="name" class="col-sm-8 control-label">Flickr ID</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="flickr_user_id" id="flickr_user_id" placeholder="Enter your flickr ID here..." value="152704974@N02">
                                                            </div>
                                                            <div class="fox-b-notice">Find your Flickr ID <a href="http://www.adamwlewis.com/articles/what-is-my-flickr-id" target="_blank">from here</a>.</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-8 control-label">Image Show</label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="flickr_img_limit" id="flickr_img_limit" placeholder="Choose how many image want to show" value="8">
                                                            </div>
                                                            <div class="fox-b-notice">Choose how many image you want to show. Default is 8.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#paypalSettings">
                                        PayPal Settings
                                        </a>
                                    </h4>
                                </div>
                                <div id="paypalSettings" class="panel-collapse collapse">
                                    <div class="panel-body import-wrap">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Client ID</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="paypal_client_id" id="paypal_client_id" placeholder="PayPal Client ID.." />
                                            </div>
                                            <div class="fox-b-notice">Enter Your PayPal App Client ID. See our documentation how to make paypal app.</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Secret Key</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="paypal_secret_key" id="paypal_secret_key" placeholder="PayPal Secret Key.." />
                                            </div>
                                            <div class="fox-b-notice">Enter Your PayPal App Secret Key. See our documentation how to make paypal app. </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Shipping Cost</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="paypal_shipping_cost" id="paypal_shipping_cost" placeholder="Shipping Cost..." value="0.00" />
                                            </div>
                                            <div class="fox-b-notice">Enter your product shipping cost here.</div>
                                        </div>

                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Website URL/Link</label>
                                            <div class="col-sm-12">
                                                <input type="url" class="form-control" name="paypal_website_link" id="paypal_website_link" placeholder="Your Website url..." />
                                            </div>
                                            <div class="fox-b-notice">Enter Your website/landing page url or link here. </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Redirect URL/Link</label>
                                            <div class="col-sm-12">
                                                <input type="url" class="form-control" name="paypal_redirect_link" id="paypal_redirect_link" placeholder="Redirect link..." />
                                            </div>
                                            <div class="fox-b-notice">Enter Your redirect url or link here. When payment will completed then paypal redirect this url/link.</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-8 control-label">Payment Description</label>
                                            <div class="col-sm-12">
                                                <textarea name="paypal_payment_desc" class="form-control" id="paypal_payment_desc" cols="30" rows="5" placeholder="Payment description...">PayForSomething Payment.</textarea>
                                            </div>
                                            <div class="fox-b-notice">Write somethig about your payment.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn fs-button danger btn-cancel" data-dismiss="modal"><span class="fui-cross"></span> Cancel</button>
                        <button type="button" class="btn fs-button dark" data-dismiss="modal" id="exportSave"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
                        <button type="submit" class="btn fs-button" id="exportSubmit"><span class="fui-export"></span>Export Now</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" type="button" class="btn btn-primary " id="deleteBlockConfirm">Delete</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Import/Export Project file</h4>
                </div>
                <div class="modal-body">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#saveTemplate">
                                    Save Template for Later Use!
                                    </a>
                                </h4>
                            </div>
                            <div id="saveTemplate" class="panel-collapse collapse in">
                                <div class="panel-body save-wrap">
                                    <form action="saveproject.php"  class="form-horizontal" method="post">
                                    <p class="save-notice">Save Template</p>
                                    ...
                                    <input id="fox-b-save" type="hidden" name="fox-b-save" value=""/>
                                    <input id="fox-b-save-flag" type="hidden" name="fox-b-save-flag" value="save"/>
                                </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#importTemplate">
                                    Import Template!
                                    </a>
                                </h4>
                            </div>
                            <div id="importTemplate" class="panel-collapse collapse">
                                <div class="panel-body import-wrap">
                                    <form class="form-horizontal" action="saveproject.php" id="import-form" method="post" enctype="multipart/form-data">
                                        <p class="import-title">Import Save Template</p>
                                        <div class="form-group">
                                            ...
                                            <div class="import-notice fox-b-notice"><b>Note:</b> Import file should be builder Project save file.</div>
                                            <input type="submit" class="btn btn-primary" id="import-site" name="upload" value="Import" />
                                        </div>
                                        <input id="fox-b-save-flag" type="hidden" name="fox-b-save-flag" value="import"/>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default  btn-cancel" data-dismiss="modal"><span class="fui-cross"></span> Cancel</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div>
    ...
    <div class="modal fade small-modal" id="resetBlock" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default " data-dismiss="modal">Cancel & Close</button>
                    <button type="button" type="button" class="btn btn-primary " id="resetBlockConfirm">Reset Block</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" type="button" class="btn btn-primary " id="deletePageConfirm">Delete Page</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="modal fade small-modal" id="deleteElement" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default " data-dismiss="modal" id="deletePageCancel">Cancel & Close</button>
                    <button type="button" type="button" class="btn btn-primary " id="deleteElementConfirm">Delete Block</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="modal fade" id="editContentModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default " data-dismiss="modal">Cancel & Close</button>
                    <button type="button" type="button" class="btn btn-primary " id="updateContentInFrameSubmit">Update Content</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary  btn-info"><span class="fui-export"></span> Preview Changes</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </form> 
    ...
    <script src="Helpers/promo/js/scripts.min.js"></script>
    <script src="Helpers/promo/js/vendor/ace/ace.js"></script>
    <script src="Helpers/promo/js/redactor/redactor.min.js"></script>
    <script src="Helpers/promo/js/redactor/table.js"></script>
    <script src="Helpers/promo/js/redactor/bufferButtons.js"></script>
	<script src="Helpers/promo/js/builder.js"></script>
</body>