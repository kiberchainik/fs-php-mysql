                    ...
                    <div class="row flex-column-reverse flex-lg-row">
                        <div class="col-xl-3 col-lg-3">
                            ...
                            <div class="siderbar-section">
                                ...
                                <div class="sidebar-single-widget">
                                    <div class="sidebar-content">
                                        <h6 class="sidebar-title title-border title-border"><?=$text_specialists?></h6>
                                        <div class="widget-catagory">
                        ...
                        <div class="col-xl-8 offset-xl-1 col-lg-9">
                            ...
                            <div class="product-shop-list-items">
                                <div class="row mb-n25">
                                    ...
                                    <?php foreach($companyList as $pl): ?>
                                    <div class="col-md-4 col-12 mb-25">
                                        <!-- Start Product Single Item - Style 1 -->
                                        <div class="product-single-item-style-1">
                                            <a rel="nofollow" href="/company/page/<?=$pl['login']?>" class="image img-responsive">
                                                <img class="img-fluid" src="/<?=$pl['user_img']?>" alt="<?=$pl['company_name']?>" />
                                            </a>
                                            <div class="content">
                                                <div class="top">
                                                    <h4 class="title"><a href="/company/page/<?=$pl['login']?>"><?=$pl['company_name']?></a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Product Single Item - Style 1 -->
